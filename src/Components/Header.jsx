...
const Header =()=>{
    ...
    //subscribing to the store using a selector / basically to get data
            ...
            <div>
                <ul className="flex gap-4">
                    ...
                    <li ><Link className=" flex" to={"/cart"}> 
                        ...
                        {cartItems.length >0 ?<div className="relative right-6 text-xs rounded-[50%] bg-red-700 p-[10px] bottom-4 mt-2">{cartItems.length}</div> : null }
                        </Link>
                    </li>
                    <button onClick={()=>{
